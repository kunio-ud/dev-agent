...
|--------|--------|--------|-----------|--------|--------|--------|--------|
| FUN-010 | SCR-USR-001 | API-010 | ユーザー一覧画面 | ○ | - | - | - |
| FUN-011 | SCR-USR-002 | API-011 | ユーザー登録画面 | - | ○ | - | - |
| FUN-012 | SCR-USR-003 | API-012 | ユーザー編集画面 | ○ | - | ○ | - |
| FUN-013 | SCR-USR-003 | API-013 | ユーザー削除（論理） | - | - | ○（deleted_at 更新） | - |
| FUN-001 | SCR-AUTH-001 | API-001 | ログイン処理 | ○ | - | ○（last_login_at 更新） | - |
